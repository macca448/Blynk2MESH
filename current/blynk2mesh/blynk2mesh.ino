...
Adafruit_NeoPixel pixels = Adafruit_NeoPixel(NUMPIXELS, STATUS, NEO_GRB + NEO_KHZ800);
...
const uint8_t   kitchenNode = 1, garageNode = 2, tank1Node = 3, septicNode = 4, all = 5,
                lightStatus = 0, valveStatus = 2, daStatus = 4, slStatus = 5, spStatus = 6,
                sbStatus = 7, mouseStatus = 3;
uint32_t        prevTime = 0;
uint8_t         lastSvalPos, doorStates, systemState, mouseTrap, gaugeTimer;
uint16_t        osPres, roomPressure, tank1Liters, t1Last24hrs = 225, t1AvgUse = 215, t1Errors;  
